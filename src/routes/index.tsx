...
function Logo({ className = "" }: { className?: string }) {
  return <img src={logoImg} alt="Joist HQ — Plan, Scan, Price" className={`h-12 w-auto rounded-sm ${className}`} />;
}
  ...
  return (
    <nav className="flex items-center justify-between px-6 sm:px-8 py-6 border-b border-steel/40">
      ...
      <div className="hidden md:flex gap-8 text-sm font-medium uppercase tracking-wider">
        <a href="#problem" className="hover:text-safety transition-colors">
          The problem
        </a>
        <a href="#how" className="hover:text-safety transition-colors">
          How it works
        </a>
        <a href="#who" className="hover:text-safety transition-colors">
          Who it's for
        </a>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          ...
          <p className="text-lg sm:text-xl text-iron/70 leading-relaxed mb-10 max-w-xl">
            The fastest way for small NZ building firms to price residential projects. Spend less time at the desk and
            more time on the tools — or with your family.
          </p>
        ...
        <div className="relative">
          <img
            ...
            width={1200}
            height={896}
            className="w-full object-cover bg-concrete shadow-2xl rounded-sm"
          />
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-steel text-lg leading-relaxed">
              Tired of spending your Sundays pulling together numbers, only for the client to ask for a "scaled-back"
              version? Joist HQ makes updates instant — without losing accuracy.
            </p>
          </div>
          {[
            {
            ...
            <div key={card.n} className="p-8 border border-white/10 hover:border-safety/50 transition-colors group">
    ...
    <section className="py-24 sm:py-32 px-6 sm:px-8 text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="inline-flex flex-col items-center">
          ...
          <p className="mt-4 text-xs font-bold text-iron/40 uppercase tracking-widest">No credit card required</p>
        </div>
      </div>
    </section>
  );
    ...
    <footer className="border-t border-steel/40 py-12 px-6 sm:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-6">
          <a href="#" className="text-xs font-bold uppercase tracking-widest hover:text-safety transition-colors">
            Privacy
          </a>
          <a href="#" className="text-xs font-bold uppercase tracking-widest hover:text-safety transition-colors">
            Terms
